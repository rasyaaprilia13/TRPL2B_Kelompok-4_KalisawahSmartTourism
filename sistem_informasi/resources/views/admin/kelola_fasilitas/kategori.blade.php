...
@section('title', 'Daftar Kategori Fasilitas')
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Kelola kategori untuk pengelompokan fasilitas</p>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.kategori-fasilitas.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf @method('DELETE')
                                </form>
                            </td>
                        </tr>
        ...
        <div class="modal-content border-0 shadow">
            <form action="{{ route('admin.kategori-fasilitas.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Nama Kategori</label>
                        <input type="text" name="nama_kategori" class="form-control" required placeholder="Contoh: Alat Camping">
                    </div>
                </div>
                <div class="modal-footer">
